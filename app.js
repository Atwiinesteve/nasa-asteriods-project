(function() {
    ...
    getInfo.addEventListener('click', getNASA);

    function getNASA() {
        var apiKey = 'OiAEyRmx4KQeB8v31oI0tlnL3qr48Y6rQMaMe3Mc';

        var request = new XMLHttpRequest();
        var startDate = document.getElementById('start__date').value;
        var endDate = document.getElementById('end__date').value;
